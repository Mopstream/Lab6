                ...
                switch (processingCode) {
                    case OBJECT:
                        try {
                            ...
                            return new Request(userCommand[0], userCommand[1], newLabadd);
                        } catch (NullPointerException exception){
                            Outputer.printerror("Создание объекта было прервано.");
                    ...
                    case UPDATE_OBJECT:
                        try {
                            ...
                            return new Request(userCommand[0], userCommand[1], newLabUpdate);
                        } catch (NullPointerException exception){
                            Outputer.printerror("Обновление объекта было прервано.");
                            return new Request("", "", null);
                        }
                    case SCRIPT:
